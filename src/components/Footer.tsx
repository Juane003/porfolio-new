    ...
    <div className="w-full flex justify-center pt-8 pb-8">
      <div className="flex items-center">
        <span className="text-zinc-200">
          &copy;{new Date().getFullYear()} Juan Emilio Rivero. All rights
          reserved
        </span>
        <div className="flex mx-3 gap-2">
          <a
            href="https://www.linkedin.com/in/juan-emilio-rivero/"
            target="_blank"
          >
            <LinkedinLogo />
          </a>
          <a href="https://github.com/Juane003" target="_blank">
            <GitHubLogo />
          </a>
        </div>
      </div>
